...
function JobDetails({ jobItem, isLoading, error }: Props) {
  return (
    <Card className="ml-8 h-[418px] w-[45vw] overflow-auto bg-slate-100">
      <CardContent>
        {isLoading ? (
          ...
          <section className="relative">
            <div>
              <Button size={"sm"} asChild className="absolute right-0 top-3">
